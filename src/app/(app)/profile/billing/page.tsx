      ...
      <Suspense fallback={<Skeleton className="h-64" />}>
        <BillingPanel
          overview={{
            ...
            originalPriceLabel: euro(overview.originalPriceCents),
            discountLabel: `-${overview.discountPercent}%`,
            couponPriceLabel: euro(overview.couponPriceCents),
            couponDiscountLabel: `-${overview.couponDiscountPercent}%`,
            paypalCouponPlanId: overview.paypalCouponPlanId,
            yearlyPriceLabel: euro(overview.yearlyPriceCents),
            yearlyOriginalPriceLabel: euro(overview.yearlyOriginalPriceCents),
            yearlyDiscountLabel: `-${overview.yearlyDiscountPercent}%`,
            stripeYearlyAvailable: overview.stripeYearlyAvailable,
            paypalYearlyAvailable: overview.paypalYearlyAvailable,
            paypalYearlyPlanId: overview.paypalYearlyPlanId,
